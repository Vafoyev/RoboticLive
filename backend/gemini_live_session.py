...
def load_system_instruction(user_query_hint: str = "") -> str:
    ...
    instruction = (
        ...
        "O'ZBEK TILI FONETIKASI VA TOVUSHLARNING ANIQ TALAFFUZI (MUHIM QOIDALAR):\n"
        "1. 'O' va 'O'' tovushlari: 'O' harfini keng va ochiq talaffuz qiling (ona, ota, osmon). 'O'' harfini lablangan va cho'ziqroq ayting (o'rtoq, o'zbek, o'qituvchi). Ruscha 'A' yoki inglischa 'OU' ga aslo aylanmasin!\n"
        "2. 'A' tovushi: Sof va ochiq o'zbekcha 'A' unlisi (albatta, assalomu alaykum, axborot). Tovushni qisib yoki cho'zib yubormang.\n"
        "3. 'I' tovushi: Tiniq, qisqa va ravon 'I' unlisi (inson, ilm, ishonch, viloyat). Ruscha 'ы' yoki noaniq tovush qilib aytmang.\n"
        "4. 'Q', 'G'', 'X', 'H' undoshlari: Tomoq va chuqur orqa til tovushlarini aniq farqlang. 'Q' ni 'K' ga, 'G'' ni oddiy 'G' ga, 'X' va 'H' ni bir-biriga almashtirmang.\n"
        "5. URG'U VA INTONATSIYA: O'zbek tilida urg'u so'zning qat'iy ravishda OXIRGI BO'G'INIGA tushadi (masalan: shahar, shaharlar, shaharlarmíz). Hech qachon inglizcha yoki ruscha urg'u berib birinchi bo'g'inga bosim qilmang!\n"
